...
func updateMovie(w http.ResponseWriter, r *http.Request) {
	...
	// delete the movie the i.d that u sent
	// add a new movie
...
func main() {
	...
	movies = append(movies, Movie{ID: "1", Isbn: "438227", Title: "Movie Two", Director: &Director{Firstname: "Adryan", Lastname: "Prawira"}})
	...
	fmt.Printf("Menyalakan server di port 8000\n")
